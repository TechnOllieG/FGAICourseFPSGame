...
#include "AITurretGame/Characters/TurretGamePlayer.h"
...
void UStateMachineComponent::BeginPlay()
{
	...
	for(int i = 0; i < States.Num(); i++)
	{
		...
		State->Player = Cast<ATurretGamePlayer>(UGameplayStatics::GetPlayerPawn(this, 0));
...
void UStateMachineComponent::ChangeState(int StateIndex)
{
	...
	OnChangeState.Broadcast(this);
	UE_LOG(LogStateMachine, Log, TEXT("OnChangeState was called with this number of stuff bound to it %i"), OnChangeState.GetAllObjects().Num())
}
